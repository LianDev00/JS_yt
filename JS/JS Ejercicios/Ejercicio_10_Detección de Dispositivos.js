...
export default function userDeviceInfo(id){
    ...
    <ul>
          ...
          <li>
            Plataforma: 
                <b>${isMobile.any()?isMobile.any():isDesktop.any()}</b>
          </li>
          <li>
            Navegador: 
                <b>${isBrowser.any()}</b>
    ...
    if(isBrowser.chrome()){
        $id.innerHTML += `
            <p><mark>Este contenido solo se puede ver en Chrome</mark></p>
        `;
    }
    if(isBrowser.firefox()){
        $id.innerHTML += `
            <p><mark>Este contenido solo se puede ver en Firefox</mark></p>
        `;
    }
    if(isBrowser.safari()){
        $id.innerHTML += `
            <p><mark>Este contenido solo se puede ver en Safari</mark></p>
        `;
    }
}